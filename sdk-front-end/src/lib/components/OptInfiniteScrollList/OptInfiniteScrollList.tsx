...
export const OptInfiniteScrollList = <T extends object>({
  ...
  function adicionarNovosItens(response: OptSearchResponse<T>, reset = false) {
    setState((currentState) => ({
      ...
      lista: reset ? [...response.data] : [...currentState.lista, ...response.data],
      carregando: false,
    }));
  ...
  }, [scrollObserver, primeiroCarregamento, possuiItens, todosRegistrosCarregados, naoPossuiRegistrosNaPagina]);
  ...
  return (
    <div ref={componenteRef}>
      ...
      {todosRegistrosCarregados && <S.MensagemFooter>Todos registros foram carregados</S.MensagemFooter>}
      {naoPossuiRegistrosNaPagina && <S.MensagemFooter>Nenhum registro encontrado</S.MensagemFooter>}
