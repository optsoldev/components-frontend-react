import { OptSideLayoutContent, OptActionToolbar, OptBreadcrumb } from "@optsol/react";

export const FiltroRegistro = () => {
  return (
    <OptSideLayoutContent>
      <OptActionToolbar noBorder title={<OptBreadcrumb />} noPadding />
